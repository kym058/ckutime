			...
			<div class="mdl-grid site-max-width">
				<div
					...
					<div class="mdl-card__title">
						<h1 class="mdl-card__title-text">회원가입</h1>
					</div>
						...
						<div class="mdl-cell mdl-cell--12-col">
							<div class="mdl-card__supporting-text">
								...
								<form action="joinAction.jsp"
									...
									<div
										class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text" id="userEmail" name="userEmail" maxlength="50">
										<label class="mdl-textfield__label" for="userEmail">이메일</label>
										<span class="mdl-textfield__error">이메일을 바르게 입력하세요</span>
									</div>												
									<p>
										<button
